...
const OrganizationsVAT: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">VAT Organizations</h1>
          <p className="text-gray-600 mt-1">Manage and monitor VAT-registered organizations</p>
        </div>
...
export default OrganizationsVAT