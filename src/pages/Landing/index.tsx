    ...
    <div className="min-h-screen bg-background-primary">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-6rem-3rem)] px-4">
        <div className="text-center max-w-6xl">
          <h1 className="text-5xl font-bold mb-8 text-gray-800 bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 bg-clip-text text-transparent leading-tight">
            Tax Operations Simplified
          </h1>
          <p className="text-2xl mb-12 text-gray-600 leading-relaxed max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Link
              to="/auth/login"
              className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-lg"
            >
              Access Platform
            </Link>
            <Link
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-green-600">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              to="/auth/register"
              className="bg-white text-blue-600 font-bold py-4 px-10 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-lg hover:bg-gray-50"
            >
              Get Started
            </Link>
            <Link
              to="/auth/login"
              className="bg-transparent border-2 border-white text-white font-bold py-4 px-10 rounded-xl hover:bg-white hover:text-blue-600 transition-all duration-300 text-lg"
            >
              Sign In
            </Link>
          </div>
